...
namespace CyclicalAutomata {
    public partial class MainForm : Form {
        ...
        private void timer_Tick(object sender, EventArgs e) {
            Invalidate();
            _controlForm.lblIterations.Text = Automata.Iterations.ToString();
        }
        public void Start() {
            if (Running) return;
            Running = true;
        ...
        protected override void OnPaint(PaintEventArgs e) {
            using (Bitmap bmp = new Bitmap(Automata.Image, ClientRectangle.Size)) {
